...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["useremail"]))) {
        ...
        try {
            ...
            $stmt->execute([trim($_POST["useremail"])]);
    ...
    if (empty($useremail_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err)) {
        ...
        try {
            ...
            $stmt->execute([$useremail, $username, $param_password, $param_token]);
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Get your free RentalMS account now.</p>
                                </div>
                                <form class="needs-validation custom-form mt-4 pt-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-0">By registering you agree to the RentalMS <a href="#" class="text-primary">Terms of Use</a></p>
                                    </div>
                                    <div class="mb-3">
