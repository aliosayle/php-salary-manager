...
// Page title
$page_title = __('monthly_sales');
$page_description = __('manage_monthly_sales_description');
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?php echo __('filter_monthly_sales'); ?></h4>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="year" name="year">
                                                <option value=""><?php echo __('all_years'); ?></option>
                                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary">
                                                <i class="bx bx-filter-alt me-1"></i> <?php echo __('apply_filters'); ?>
                                            </button>
                                            <a href="monthly-sales.php" class="btn btn-secondary ms-2">
                                                <i class="bx bx-reset me-1"></i> <?php echo __('reset'); ?>
                                            </a>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="col-12">
                        <div class="card table-card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="card-title mb-0"><?php echo __('monthly_sales_records'); ?></h4>
                                    <p class="text-muted mb-0"><?php echo __('monthly_sales_records_description'); ?></p>
                                </div>
                                <div>
                                    <button type="button" id="save-all-sales" class="btn btn-primary">
                                        <i class="bx bx-save me-1"></i> <?php echo __('save_all_sales'); ?>
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <table id="sales-table" class="table table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead class="thead-light sticky-top" style="position: sticky; top: 0; z-index: 1; background-color: #f8f9fa;">
                                                <tr>
                                                    ...
                                                    <th><?php echo __('bonus_amount'); ?></th>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0"><?php echo __('bonus_percentage_key'); ?></h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            <?php if (empty($bonusTiers)): ?>
                                                <tr>
                                                    <td colspan="2" class="text-center"><?php echo __('no_bonus_configurations'); ?></td>
                                                </tr>
                                            <?php else: ?>
                                                <?php foreach ($bonusTiers as $tier): ?>
                                                    <tr>
                                                        <td><?php echo formatCurrency($tier['min_sales']); ?></td>
                                                        <td><?php echo number_format($tier['bonus_percent'], 2); ?>%</td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteSalesModalLabel"><?php echo __('delete_sales_record'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="post" id="deleteSalesForm" action="monthly-sales.php">
                <div class="modal-body">
                    <p><?php echo __('confirm_delete_sales'); ?></p>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="delete_sales" class="btn btn-danger"><?php echo __('delete'); ?></button>
                </div>
            </form>
        </div>
    </div>
